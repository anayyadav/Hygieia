...
def get_data(server_url,client_id,client_secret):
	...
	for i in range(len(workspace_data)):
		...
		release_burn_down.getreleaseforecast(release_data,backlog_data,wname,wid)
...
#		print "Could not connect to MongoDB"
	...
	final_data["hpamReleaseforecast"] = rBurn.get_data()
	#print final_data["hpamReleaseforecast"]
