...
public class HPAMData extends BaseModel {
	...
	private List<HPAMReleaseForecast> hpamReleaseforecast = new ArrayList<>();
	
	public List<HPAMReleaseForecast> getHpamReleaseforecast() {
		return hpamReleaseforecast;
	}
	public void setHpamReleaseforecast(List<HPAMReleaseForecast> hpamReleaseforecast) {
		this.hpamReleaseforecast = hpamReleaseforecast;
	}
	...
	public HPAMData( List<HPAMRelease> hpamRelease, List<HPAMSprint> hpamSprint,List<HPAMReleaseForecast> hpamReleaseforecast
,			List<HPPAMDefectConc> hpamDefectConcentration, List<HPAMDefectRejection> hpamDefectRejection,
	...
	public String toString() {
		return "hpamRelease=" + hpamRelease + "hpamSprint=" + hpamSprint+"hpamReleaseforecast=" + hpamReleaseforecast
