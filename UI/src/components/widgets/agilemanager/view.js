...
(function () {
    ...
    function AgileManagerWidgetViewController($scope, hpamData, $q, $uibModal) {
		...
		ctrl.ReleaseForecastChart = function(){
			var releaseForecastData=[];
			
			var releaseforecast = ctrl.agileManagerDetails[0].hpamReleaseforecast;
			var startDate =releaseforecast[0]['startdate'];
			var endDate= releaseforecast[0]['enddate'];
        ...
        ctrl.loadhpamReleaseforecast = function (agileManagerDetails) {
            var f = [];
            f = agileManagerDetails[0].hpamReleaseforecast.filter(function (item) {
        ...
        ctrl.load = function () {
            hpamData.details($scope.widgetConfig.componentId).
                then(function (data) {
                    ...
                    var filtered9 = ctrl.loadhpamReleaseforecast(ctrl.agileManagerDetails);
                    ...
                    ctrl.agileManagerDetails[0].hpamReleaseforecast = angular.copy(filtered9);
                    ...
                    ctrl.copyAgileManagerDetails[0].hpamReleaseforecast = angular.copy(filtered9);
                    ctrl.minitabs = [
                        { name: ctrl.tab1 },
                        { name: ctrl.tab2 },
                        { name: ctrl.tab3 }
...
ctrl.ReleaseForecastChart();					
        ...
        ctrl.showDetail = function () {
            $uibModal.open({
                ...
                size: 'lg',
				resolve: {
                    releaseforecast: function() {
                        return ctrl.agileManagerDetails[0].hpamReleaseforecast;
                    }
                }
