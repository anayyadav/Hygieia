...
(function () {
    ...
    BuildGitlabWidgetConfigController.$inject = ['modalData', '$scope', 'gitlabData', '$uibModalInstance'];
    function BuildGitlabWidgetConfigController(modalData, $scope, gitlabData, $uibModalInstance) {
        var ctrl = this,
        ...
        ctrl.load = function () {
            ...
            gitlabData.details(widgetConfig.options.id).
                then(function (data) {
